...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-leadmanagement';
        ...
        */
        ...
        return view('leadmanagement::backend.pages.app');
...
//        $steps[] = $this->isSetupComplete();
        ...
        $data['module'] = [
            'name' => config('leadmanagement.name'),
            'version' => config('settings.global.leadmanagement_version')??config('leadmanagement.version'),
            'is_dev' => config('leadmanagement.is_dev'),
            'setup' => [
                'steps' => $steps
            ]
        ];
