    ...
    <div v-if="store.list">
        <!--table-->
         <DataTable :value="store.list.data"
            ...
            <Column field="lead_id" header="Lead"
            ...
            <Column field="is_active" v-if="store.isViewLarge()"
                ...
                <template #body="prop">
                    <InputSwitch v-model.bool="prop.data.is_active"
                                 data-testid="followups-table-is-active"
                ...
                <template #body="prop">
                    <div class="p-inputgroup ">
                        ...
                        <Button class="p-button-tiny p-button-text"
                                data-testid="followups-table-to-view"
                                v-tooltip.top="'View'"
                                @click="store.toView(prop.data)"
                                icon="pi pi-eye" />

                        <Button class="p-button-tiny p-button-text"
                                data-testid="followups-table-to-edit"
                                v-tooltip.top="'Update'"
                                @click="store.toEdit(prop.data)"
                                icon="pi pi-pencil" />

                        <Button class="p-button-tiny p-button-danger p-button-text"
                                data-testid="followups-table-action-trash"
                        ...
                        <Button class="p-button-tiny p-button-success p-button-text"
                                data-testid="followups-table-action-restore"
                                v-if="store.isViewLarge() && prop.data.deleted_at"
